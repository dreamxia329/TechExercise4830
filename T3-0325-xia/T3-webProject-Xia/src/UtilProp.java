...
public class UtilProp {
   ...
   static String _PROP_FILENAME_OSX_LOCAL = "/Users/dreamxia/CSCI4830/TechExerciseWorkspace4830/T3-0325-xia/T3-webProject-Xia/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/T3-webProject-Xia/config.properties";
