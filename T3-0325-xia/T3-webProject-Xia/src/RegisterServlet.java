...
public class RegisterServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		boolean check = true;
		String warningMessage = "Invalid input, Fields with (*) are required";
		if ((studentName.isEmpty() || studentAge.isEmpty() || studentGrade.isEmpty() || parentName.isEmpty()
				|| parentPhone.isEmpty() || parentEmail.isEmpty() || address.isEmpty())) {
			check = false;
		...
		if (check == true) {
			...
			String thanks = "Thanks for registering";
			...
			out.print("<html><h1><font color=red>" + warningMessage + "</font></h1>");
			out.println("<body bgcolor=\"#f0f0f0\">\n");
		}

		out.println("<a href=/T3-webProject-Xia/register.html>Back to Home page</a> <br>");
